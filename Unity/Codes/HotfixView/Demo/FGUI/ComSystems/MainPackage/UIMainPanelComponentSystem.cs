...
{
string name= UIManagerComponentSystem.GetClassName(UIEnum.Panel_Main.ToString());self.UIMainController =(UIMainController) UIManagerComponentSystem.LoadWindow(name); self.UIMainController.SelfUIPackageEnum = UIPackageEnum.MainPackage; self.UIMainController.UiEnum = UIEnum.Panel_Main;}
public static void Show(this UIMainPanelComponent self)
{
Game.Scene.GetComponent<UIManagerComponent>().OpenWindow(self.UIMainController);self.OnShow();}
...
{
Game.Scene.GetComponent<UIManagerComponent>().CloseWindow(self.UIMainController);self.DelEvent();}
public static void TurnToOpenPanel(this UIMainPanelComponent self, UIEnum className, UiLayer layer, UIPackageEnum packageName = UIPackageEnum.Null, bool isModal = false,params object[] values)
{
